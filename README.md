...
<pre> archive/ ├── gallery/ │ ├── gallery_metadata.csv │ ├── &lt;gallery_id&gt;/ │ │ ├── 01_15_25/ # encounter folder (MM_DD_YY[_...]) │ │ │ └── *.jpg | *.png | ... # images │ │ └── 03_02_25_A/ # additional encounters allowed │ ├── queries/ │ ├── queries_metadata.csv │ ├── &lt;query_id&gt;/ │ │ ├── 12_05_24/ │ │ │ └── *.jpg | *.png | ... │ │ └── _second_order_labels.csv # created by the app when you label pairs │ ├── logs/ │ └── first_order_&lt;query&gt;_&lt;timestamp&gt;.csv # only if STARBOARD_DUMP_RANK_CSV is set │ ├── reports/ │ └── past_matches_master.csv # created by the Past Matches export │ └── starboard.log # rotating app log </pre>
