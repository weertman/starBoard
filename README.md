...
flowchart TB
    subgraph UI [User Interface - PySide6/Qt]
        ...
        MainWindow --> TabPast[Past Matches Tab]
...
| **Past Matches** | Review decision history, merge confirmed matches | Field & Lab |
...
1. Go to **Past Matches** tab → **Revert** section
