...
from src.utils.model_downloader import ensure_models
...
def main():
    ...
    # Check for and download missing model weights on first run
    print("\nChecking for model weights...")
    if not ensure_models(project_root):
        print("\nWarning: Some model files could not be downloaded.")
        print("The app will start, but some features may not work.")
        print("You can retry later with: python -m src.utils.model_downloader\n")
