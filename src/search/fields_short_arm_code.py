...
SEV_ORD: Dict[str, int] = {"tiny": 0, "small": 1, "short": 2}
SEV_NAMES: Dict[int, str] = {0: "tiny", 1: "small", 2: "short"}

# Pattern to parse "tiny(2)", "small(10)", etc.
_ARM_PATTERN = re.compile(r"(tiny|small|short)\s*\(\s*(\d+)\s*\)", re.IGNORECASE)
...
def severity_similarity(sev1: str, sev2: str) -> float:
    ...
    Returns:
        ...
        0.5 if off by 1 (e.g., tiny vs small)
        0.0 if off by 2 (e.g., tiny vs short)
    """
