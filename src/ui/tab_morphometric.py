...
class TabMorphometric(QWidget):
    ...
    def _build_action_buttons(self) -> QWidget:
        ...
        # Row of three buttons: Detect, Morph, Volume
        btn_row = QHBoxLayout()
        btn_row.setSpacing(4)
        
        self.btn_capture = QPushButton("Detect")
        self.btn_capture.setToolTip("Capture current detection")
        self.btn_capture.clicked.connect(self._on_capture)
        self.btn_capture.setEnabled(False)
        btn_row.addWidget(self.btn_capture)
        
        self.btn_analyze = QPushButton("Morph")
        self.btn_analyze.setToolTip("Run morphometric analysis")
        self.btn_analyze.clicked.connect(self._on_analyze)
        self.btn_analyze.setEnabled(False)
        btn_row.addWidget(self.btn_analyze)
        
        self.btn_volume = QPushButton("Volume")
        self.btn_volume.setToolTip("Estimate 3D volume (slow)")
        self.btn_volume.clicked.connect(self._on_estimate_volume)
        self.btn_volume.setEnabled(False)
        self.btn_volume.setStyleSheet("QPushButton { background-color: #1565c0; color: white; }")
    ...
    def _on_analyze(self):
        ...
        self.btn_volume.setEnabled(True)  # Enable volume estimation after analysis
    ...
    def _on_estimate_volume(self):
        ...
        self.btn_volume.setEnabled(False)
        self.btn_volume.setText("Estimating...")
        from PySide6.QtWidgets import QApplication
        QApplication.processEvents()
        ...
        try:
            ...
            logger.info("Volume estimation complete: %.1f mm³", volume_mm3)
            ...
            # Re-enable button
            self.btn_volume.setText("Estimate Volume")
    ...
    def _on_save(self):
        ...
        try:
            ...
            self.lbl_depth.setText("Depth Map")
            self.lbl_depth.setPixmap(QPixmap())
