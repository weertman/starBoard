...
HELP_TEXTS = {
    ...
    'setup_star_dataset_import': 'Import images from a star_dataset_raw directory. This directory uses a 3-level structure: data_group / individual_id / encounter_folder. Encounter folders are named with M_D_YYYY_description format (e.g. 6_10_2022_dock_gopro). The importer converts dates to starBoard MM_DD_YY format automatically. Check the individuals you want to import, choose Gallery or Queries, and click Import Selected.',
